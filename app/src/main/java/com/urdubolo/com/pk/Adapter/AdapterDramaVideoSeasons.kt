...
class AdapterDramaVideoSeasons(private val seasonList: List<ModelSeasonItem>,var context: Context,var listener:ItemcClicklistner) :
    RecyclerView.Adapter<AdapterDramaVideoSeasons.DramaViewHolder>() {
     ...
     */
        val laySeason: CardView = itemView.findViewById(R.id.laySeasons)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DramaViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_drama_video_seasons, parent, false)
